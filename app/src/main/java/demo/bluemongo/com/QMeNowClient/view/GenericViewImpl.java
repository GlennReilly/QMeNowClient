...
import demo.bluemongo.com.QMeNowClient.presenter.GenericPresenter;
 ...
 */
public class GenericViewImpl extends Fragment {
    ...
    public void setView(GenericViewImpl view) {
        this.view = view;
    }
