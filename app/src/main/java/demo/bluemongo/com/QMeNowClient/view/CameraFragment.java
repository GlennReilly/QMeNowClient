...
import demo.bluemongo.com.QMeNowClient.cameraui.CameraSourcePreview;
import demo.bluemongo.com.QMeNowClient.cameraui.GraphicOverlay;
...
import demo.bluemongo.com.QMeNowClient.presenter.CameraPreviewPresenter;
import demo.bluemongo.com.QMeNowClient.service.BarcodeTrackerFactory;
...
public class CameraFragment extends GenericViewImpl implements CameraPreviewView {
    ...
    private String recentBarCodeResult = "";
    @Override
    public void onBarcodeResult(String rawValue) {
    ...
    @Override
    public void onValidCustomerBarcodeResult(CustomerQRCodePayload customerQRCodePayload) {
        mListener.populateCustomerDetailsFromBarcode(customerQRCodePayload);
    }
...
/*        FaceDetector faceDetector = new FaceDetector.Builder(context).build();
        ...
        if (!multiDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getActivity().getApplicationContext(), R.string.low_storage_error, Toast.LENGTH_LONG).show();
